...
export class CandidatesSetCandidateComment extends MainRequestClass {
  ...
  action = '';
  // "для" (для какой сущности) чего создается комментарий (доступные значения для type: 'for_candidate': общий комментарий для кандидата; 'for_otklic:id_вакансии': комментарий для кандидата по отношению к отклику)
  commentFor = '';
